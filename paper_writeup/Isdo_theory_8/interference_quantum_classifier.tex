...
\begin{itemize}
    ...
    \item A \textbf{classical learning phase} using centroid prototypes, decoupling training from quantum execution, with experimental validation achieving 88.07\% accuracy on the PCam validation subset.
\end{itemize}
...
\subsection{Challenges in Existing Systems}
